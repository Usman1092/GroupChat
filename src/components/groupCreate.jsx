  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <input
        ...
        onChange={(e) => setGroupPhoto(e.target.files[0])}
      />
      <button className="bg-tb w-[80%] ml-auto mr-auto rounded-[0%]" onClick={handleAddMember}>Add Member</button>
      <button className="bg-bg1 w-[80%] ml-auto mr-auto rounded-[0%]" onClick={handleCreateGroup}>Create Group</button>
      <div>
        <h3 className="text-[#fff] text-center">Members:</h3>
        <ul>
          {members.map((member, index) => (
